...
def test_user_failed():
    ...
    with pytest.raises(Exception) as e_info:
        User(
            access_token="eyJhbGciOiJIUzI1NiJ9..ajVzgRfeLwB1IuMzldnzrmoUtUFFmh3QGmWQcs-3Flc"
        )
...
def test_get_invalid_user():
    ...
    assert user_invalid["status"] == "failed"
    assert "detail" in user_invalid["response"]
